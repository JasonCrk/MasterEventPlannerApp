...
const ConnectionInvitation: FC<Props> = ({
  userId,
  avatar,
  username,
  notifiedAt,
  ...
  return (
    <div className="mx-auto d-flex align-items-center border rounded p-3 bg-white text-dark" style={{ maxWidth: '500px' }}>
      ...
      <div className="ms-3 flex-grow-1">
        ...
        <div>Notified At: {notifiedAt}</div>
      </div>
